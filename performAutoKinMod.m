...
%% Step -1: Select steps to be performed

performDICOMImport = true;
performMovCor = true;
performACOrig = true;
...
%Try to read status of checkboxes in GUI
try
    performDICOMImport = app.chkDicom.Value;
    performMovCor = app.chkMovCor.Value;
    performACOrig = app.chkACOrig.Value;
    performSpatialNorm = app.chkSpatialNorm.Value;
